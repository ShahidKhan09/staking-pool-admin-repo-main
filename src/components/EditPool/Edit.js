  ...
  const CreatePool = async () => {
    ...
    try {
      ...
      if (approved) {
        ...
        data1.append("stakingTokenName", inputs?.stakingTokenName);
        data1.append("stakingTokenSymbol", inputs?.stakingTokenSymbol);
        if (MyFiles) {
        ...
        data1.append("stakingTokenAddress", inputs?.stakingTokenAddress);
        data1.append("stakingDecimals", inputs?.stakingDecimals);
        data1.append("rewardTokenName", inputs?.rewardTokenName);
        data1.append("rewardTokenSymbol", inputs?.rewardTokenSymbol);
        data1.append("rewardTokenAddress", inputs?.rewardTokenAddress);
        data1.append("rewardDecimals", inputs?.rewardDecimals);
        data1.append("lockPeriod", inputs?.lockPeriod);
        data1.append("rewardWalletAddress", inputs?.rewardWalletAddress);
        data1.append("maxSupplyOfRewadPool", inputs?.maxSupplyOfRewadPool);
        data1.append("ApyPerscentage", inputs?.ApyPerscentage);
        data1.append("isStakingTokenBnb", inputs?.isStakingTokenBnb);
        data1.append("isRewardTokenBnb", inputs?.isRewardTokenBnb);
        data1.append(
          "allowPrematureUnstaking",
          inputs?.allowPrematureUnstaking
        );
        ...
        console.log("appprrrrr", inputs?.autoCompound);
        console.log("---------------++++++++++++++++++++++++++++++++++++");
            ...
            <div className="col-xl-11 col-12 m-auto">
              ...
              <div className="two-switch box-shadow">
                <div className="switch">
                  {
                    <div class="custom-control custom-switch">
                      {console.log("chckcp=ompin", inputs?.autoCompound)}
                      <input
                        name="autoCompound"
                        type="checkbox"
                        class="custom-control-input"
                        id="customSwitch2"
                        // defaultChecked={inputs?.autoCompound}
                ...
                <div className="switch">
                  <div class="custom-control custom-switch">
                    <input
                      name="feeforPrematureUnstaking"
                      type="checkbox"
                      class="custom-control-input"
                      defaultChecked={inputs?.allowPrematureUnstaking}
                      id="customSwitch5"
                      // onChange={handleCompound1}
                      disabled
                      // onChange={handlepremature}
                    />
                  ...
                  <div className="input-field">
                    {inputs?.allowPrematureUnstaking == true ? (
                      <>
                        ...
                        <input
                          ...
                          name="feeforPrematureUnstaking"
                          onChange={handleChange1}
                          value={inputs?.feeforPrematureUnstaking}
                          className="input-create"
                        />
                        <br />
                        <p className="switch-para">

...
import { getFactoryVariableContract } from "../../utils/contractHelpers";
  ...
  const CreatePool = async () => {
    ...
    if (inputs.tokenBNB && inputs.rewardBNB) {
      ...
      arg = {
        ...
        _withUpdate: true,
        _rewardPerBlock: web3.utils.toWei(inputs?.RewardPerBlock) 
      };
    }
    // BNB FOR TOKEN
    ...
    // TOKEN FOR BNB
      ...
      arg = {
        ...
        _maxReward: inputs.maxSupplyReward,
        _withUpdate: true,
        rewardPerBlock: inputs?.RewardPerBlock
      };
    ...
    console.log(
      ...
      deployNewCollection,
      arg,
      Environment.factoryContarctVariable
    );
    try {
      const contract = getFactoryVariableContract(Environment.factoryContarctVariable, web3);
      ...
      data1.append("variable", true);
      data1.append("rewardPerBlock", inputs.RewardPerBlock);
